...
},
{
  ...
  answer: 1,
  vi: "Trong ngành xây dựng, ba loại tai nạn nghiêm trọng nhất (三大災害) là gì?",
  explain: "Ba tai nạn lớn nhất trong ngành xây dựng là 感電（かんでん／điện giật）, 墜落・転落（ついらく・てんらく／ngã từ trên cao）, và 崩壊・倒壊（ほうかい・とうかい／sập đổ công trình）.",
  tip: "💡 Nhớ: ⚡感電（điện giật）・💀墜落（ngã）・🧱崩壊（sập） → 三大災害！"
},
  {
