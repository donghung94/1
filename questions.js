...
{
  id: 7,
  q: "問7 「おつかれさまです」はどんな時（とき）に挨拶（あいさつ）するか。",
  options: [
    "他（ほか）の人（ひと）は大変（たいへん）そうだと見（み）えます。",
    "仕事（しごと）が終（お）わるときにあいさつします。",
    "休憩（きゅうけい）の時（とき）にあいさつします。",
    "すべて正解（せいかい）です。"
  ],
  answer: 1,
  vi: "Khi nào người ta nói 'おつかれさまです'?",
  explain: "Đáp án đúng: 2 — Dùng để chào khi công việc kết thúc hoặc khi cảm ơn ai đó vì đã vất vả."
},
{
  id: 8,
...
{
  q: "問30　タワークレーンを使（つか）って、１階（いっかい）ずつ組（く）み上（あ）げていく方法（ほうほう）は何（なん）というか。",
  options: [
    "ブラケット工法（こうほう）",
    "建（た）て逃（に）げ方式（ほうしき）",
    "ノンブラケット工法（こうほう）",
  ...
  answer: 0,
  vi: "Khi dùng cần trục tháp để lắp ráp từng tầng một, gọi là phương pháp giá đỡ.",
  explain: "Đáp án đúng: ブラケット工法（こうほう） — Phương pháp lắp dựng tầng bằng giá đỡ."
},
{
...
{
  q: "問32　事業（じぎょう）活動（かつどう）で生（しょう）じたごみは２つに分（わ）けられる。以下（いか）の種類（しゅるい）で正（ただ）しいものを選（えら）べ。",
  options: [
    "家庭（かてい）廃棄物（はいきぶつ）と農業（のうぎょう）廃棄物（はいきぶつ）",
    "産業（さんぎょう）廃棄物（はいきぶつ）と事業系（じぎょうけい）一般（いっぱん）廃棄物（はいきぶつ）",
    "農業（のうぎょう）廃棄物（はいきぶつ）と事業系（じぎょうけい）一般（いっぱん）廃棄物（はいきぶつ）",
    "産業（さんぎょう）廃棄物（はいきぶつ）と家庭（かてい）廃棄物（はいきぶつ）"
  ],
  answer: 3,
  vi: "Rác phát sinh trong hoạt động kinh doanh được chia thành hai loại: rác công nghiệp và rác sinh hoạt gia đình.",
  explain: "Đáp án đúng: 産業廃棄物（さんぎょうはいきぶつ）と家庭廃棄物（かていはいきぶつ） — Rác công nghiệp và rác gia đình."
},
{
