...
window.QUESTION_SETS["4"] = [
  ...
  },
  {
    ...
    options: [
      "設計者（せっけいしゃ）の許可（きょか）",
      "産業（さんぎょう）廃棄物（はいきぶつ）収集（しゅうしゅう）運搬業（うんぱんぎょう）の許可（きょか）",
      "発注者（はっちゅうしゃ）の許可（きょか）",
      "建設業（けんせつぎょう）許可（きょか）"
    ],
    answer: 1,
  ...
  },
 {
  ...
  },
  {
    ...
    answer: 0,
    vi: "Cải cách kinh doanh nhờ ứng dụng công nghệ số được gọi là DX (Digital Transformation).",
    explain: "DX = デジタルトランスフォーメーション, nghĩa là chuyển đổi kỹ thuật số – dùng công nghệ để nâng cao năng suất, tối ưu quy trình trong doanh nghiệp."
  },
  {
    q: "問148　建設（けんせつ）現場（げんば）における5S活動（かつどう）の「しつけ（Shitsuke）」の説明（せつめい）として適切（てきせつ）なものは、次（つぎ）のうちどれか。",
    options: [
      "効率的（こうりつてき）な作業（さぎょう）環境（かんきょう）を維持（いじ）するために、常（つね）に整理（せいり）整頓（せいとん）や清掃（せいそう）を行（おこな）い、清潔（せいけつ）な状態（じょうたい）を保（たも）つ",
      "必要（ひつよう）な物（もの）を必要（ひつよう）な数（かず）だけ配置（はいち）し、不必要（ふひつよう）な物（もの）は廃棄（はいき）するなど、整理（せいり）する",
      "5S活動（かつどう）を継続的（けいぞくてき）に実施（じっし）するためのルールやマナーを決（き）め、それらを守（まも）って行動（こうどう）できるための教育（きょういく）を行（おこな）う",
      "整理（せいり）した物（もの）を探（さが）しやすく配置（はいち）するなどの工夫（くふう）をして、整頓（せいとん）を行（おこな）う"
    ],
    answer: 2,
    vi: "‘しつけ’ trong 5S nghĩa là giáo dục, rèn luyện thói quen tuân thủ quy định và hành động có kỷ luật.",
    explain: "Trong 5S: 整理 (Sắp xếp)・整頓 (Ngăn nắp)・清掃 (Dọn dẹp)・清潔 (Sạch sẽ)・しつけ (Rèn luyện). しつけ nghĩa là hình thành thói quen và ý thức tự giác tuân thủ nội quy."
  },
   {
    q: "問149　リスク低減（ていげん）措置（そち）の検討（けんとう）における「管理的（かんりてき）対策（たいさく）」として行（おこな）うものは、次（つぎ）のうちどれか。【63】",
    options: [
      "作業（さぎょう）そのものの廃止（はいし）",
      "作業（さぎょう）マニュアルの整備（せいび）",
      "保護（ほご）手袋（てぶくろ）などの保護（ほご）用具（ようぐ）の使用（しよう）",
  ...
  {
    q: "問152　設計図（せっけいず）を作成（さくせい）する人（ひと）を選（えら）べ。【81】",
    options: [
      "設計（せっけい）事務所（じむしょ）",
      "施工（せこう）管理者（かんりしゃ）",
      "施主（せしゅ）",
  ...
  {
    q: "問156　コンクリート打設工事（だせつこうじ）は、型枠（かたわく）を隅々（すみずみ）まで行（い）きわたらせるため、バイブレータを使（つか）ったり、ハンマーで型枠（かたわく）を叩（たた）いたりする不要（ふよう）な空気（くうき）を除去（じょきょ）する作業（さぎょう）は何（なん）という？",
    options: [
      "締（し）め固（かた）め",
      "練（ね）り混（ま）ぜ",
      "敷（し）き均（なら）し",
  ...
  },
  {
    ...
    options: [
      "当日（とうじつ）の安全（あんぜん）パトロールをするときだけ、しっかりを実施（じっし）する",
...
},
{
  ...
  },
  {
    ...
    options: [
      "発破（はっぱ）の業務（ぎょうむ）",
      "酸素（さんそ）欠乏（けつぼう）危険（きけん）作業（さぎょう）に係（かか）る業務（ぎょうむ）",
      "ボーリングマシンの運転（うんてん）業務（ぎょうむ）",
      "ゴンドラの操作（そうさ）"
    ],
    answer: 0,
  ...
  },
  {
    ...
    options: [
      "工事（こうじ）施工（せこう）を行（おこな）う作業員（さぎょういん）の人件費（じんけんひ）",
      "工事（こうじ）の施工（せこう）のために直接（ちょくせつ）購入（こうにゅう）された素材（そざい）などの物品（ぶっぴん）",
      "工事（こうじ）を施工（せこう）するときにその工程（こうてい）の一部（いちぶ）を他（ほか）の業者（ぎょうしゃ）などに発注（はっちゅう）する費用（ひよう）",
  ...
  },
  {
    ...
    options: [
      ...
      "災害時（さいがいじ）には、被災（ひさい）施設（しせつ）の修復（しゅうふく）や再建（さいけん）を行（おこな）う役割（やくわり）"
    ],
    answer: 2,
    vi: "Trong các vai trò xã hội của ngành xây dựng, điều nào sau đây là sai?",
    explain: "Ngành xây dựng có vai trò phát triển hạ tầng, cải thiện đời sống, tái thiết sau thiên tai. Việc ‘phá hoại môi trường tự nhiên’ không phải là vai trò mà là hậu quả cần tránh."
  },
  {
    q: "問168　主任技術者（しゅにんぎじゅつしゃ）にない作業（さぎょう）を選（えら）べ。",
    options: [
  ...
  },
  {
    ...
    options: [
      "週休（しゅうきゅう）2日（ふつか）を確保（かくほ）する",
      "技術者（ぎじゅつしゃ）・技能者（ぎのうしゃ）の教育（きょういく）は、職長（しょくちょう）の能力（のうりょく）育成（いくせい）を発揮（はっき）できる",
      "職長（しょくちょう）は、有給（ゆうきゅう）取得（しゅとく）を言（い）い出（だ）しにくい環境（かんきょう）を作（つく）ることが大切（たいせつ）",
  ...
  },
  {
    ...
    options: [
      ...
      "建物（たてもの）を建（た）てる敷地内（しきちない）の周（まわ）りに囲（かこ）いを立（た）てる",
      "建物（たてもの）を支（ささ）えるための杭（くい）を地中（ちちゅう）に埋（う）め込（こ）むこと",
      "地面（じめん）より下（した）の構造物（こうぞうぶつ）を作（つく）るために、地面（じめん）を掘削（くっさく）する"
    ],
    answer: 2,
  ...
  },
  {
    ...
    options: [
      "決（き）められたことやルールをいつも正（ただ）しく守（まも）る",
      "要（い）るものと要（い）らないものを分（わ）けて、要（い）らないものを捨（す）てる",
      "使（つか）いやすいようにきちんと置（お）き、表示（ひょうじ）する",
  ...
  },
  {
    ...
    answer: 2,
    vi: "Công trình trải nhựa đường, làm phẳng và lu lèn được gọi là gì?",
    explain: "Công trình trải nhựa đường, làm phẳng và lu lèn gọi là 表層工事（ひょうそうこうじ） – công trình lớp bề mặt."
  },
  {
    q: "問4　工事（こうじ）を施工（せこう）するときに、その工程（こうてい）の一部（いちぶ）を他（ほか）の業者（ぎょうしゃ）などに発注（はっちゅう）する費用（ひよう）を何（なん）というか。",
    options: [
      "材料費（ざいりょうひ）",
      "外注費（がいちゅうひ）",
      "労務費（ろうむひ）",
  ...
  },
  {
    ...
    options: [
      ...
      "道路交通（どうろこうつう）に関（かん）する法律（ほうりつ）です。",
  ...
  },
  {
    ...
    answer: 3,
    vi: "Trải đá dăm lên lớp nền đường tạo ra lớp gì?",
    explain: "Lớp trải đá dăm trên nền đường được gọi là 路盤工事（ろばんこうじ）– công trình lớp mặt đường."
  },
  {
    q: "問14　日本（にほん）の住宅（じゅうたく）や神社（じんじゃ）、寺（てら）などの屋根用（やねよう）の材料（ざいりょう）は何（なん）か。",
    options: [
      "粘土（ねんど）瓦（がわら）",
      "木材（もくざい）",
      "アスファルトシングル",
